...
/**
 * Base class that represents a row from the 'user_profiles' table.
 *
 *
 *
...
abstract class BaseUserProfile extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'AnthemCM\\UserProfile\\Model\\UserProfilePeer';
    ...
    public function setFirstname($v)
    {
        ...
        if ($this->firstname !== $v) {
            $this->firstname = $v;
            $this->modifiedColumns[] = UserProfilePeer::FIRSTNAME;
        }
    ...
    public function setLastname($v)
    {
        ...
        if ($this->lastname !== $v) {
            $this->lastname = $v;
            $this->modifiedColumns[] = UserProfilePeer::LASTNAME;
        }
    ...
    public function setNickname($v)
    {
        ...
        if ($this->nickname !== $v) {
            $this->nickname = $v;
            $this->modifiedColumns[] = UserProfilePeer::NICKNAME;
        }
    ...
    public function setAvatar($v)
    {
        ...
        if ($this->avatar !== $v) {
            $this->avatar = $v;
            $this->modifiedColumns[] = UserProfilePeer::AVATAR;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->avatar = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            $this->resetModified();
            ...
            return $startcol + 5; // 5 = UserProfilePeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(UserProfilePeer::FIRSTNAME)) {
            $modifiedColumns[':p' . $index++]  = '`firstname`';
        }
        if ($this->isColumnModified(UserProfilePeer::LASTNAME)) {
            $modifiedColumns[':p' . $index++]  = '`lastname`';
        }
        if ($this->isColumnModified(UserProfilePeer::NICKNAME)) {
            $modifiedColumns[':p' . $index++]  = '`nickname`';
        }
        if ($this->isColumnModified(UserProfilePeer::AVATAR)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserProfilePeer::FIRSTNAME)) $criteria->add(UserProfilePeer::FIRSTNAME, $this->firstname);
        if ($this->isColumnModified(UserProfilePeer::LASTNAME)) $criteria->add(UserProfilePeer::LASTNAME, $this->lastname);
        if ($this->isColumnModified(UserProfilePeer::NICKNAME)) $criteria->add(UserProfilePeer::NICKNAME, $this->nickname);
        if ($this->isColumnModified(UserProfilePeer::AVATAR)) $criteria->add(UserProfilePeer::AVATAR, $this->avatar);
