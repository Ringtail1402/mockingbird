...
use AnthemCM\UserProfile\Model\map\UserProfileTableMap;
use Anthem\Auth\Model\UserPeer;

/**
 * Base static class for performing query and update operations on the 'user_profiles' table.
 *
 *
 *
...
abstract class BaseUserProfilePeer
{
    ...
    const OM_CLASS = 'AnthemCM\\UserProfile\\Model\\UserProfile';

    /** the related TableMap class for this table */
    const TM_CLASS = 'AnthemCM\\UserProfile\\Model\\map\\UserProfileTableMap';
    ...
    const ID = 'user_profiles.id';

    /** the column name for the firstname field */
    const FIRSTNAME = 'user_profiles.firstname';

    /** the column name for the lastname field */
    const LASTNAME = 'user_profiles.lastname';

    /** the column name for the nickname field */
    const NICKNAME = 'user_profiles.nickname';

    /** the column name for the avatar field */
    const AVATAR = 'user_profiles.avatar';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Firstname', 'Lastname', 'Nickname', 'Avatar', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'firstname', 'lastname', 'nickname', 'avatar', ),
        BasePeer::TYPE_COLNAME => array (UserProfilePeer::ID, UserProfilePeer::FIRSTNAME, UserProfilePeer::LASTNAME, UserProfilePeer::NICKNAME, UserProfilePeer::AVATAR, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'FIRSTNAME', 'LASTNAME', 'NICKNAME', 'AVATAR', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'firstname', 'lastname', 'nickname', 'avatar', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Firstname' => 1, 'Lastname' => 2, 'Nickname' => 3, 'Avatar' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'firstname' => 1, 'lastname' => 2, 'nickname' => 3, 'avatar' => 4, ),
        BasePeer::TYPE_COLNAME => array (UserProfilePeer::ID => 0, UserProfilePeer::FIRSTNAME => 1, UserProfilePeer::LASTNAME => 2, UserProfilePeer::NICKNAME => 3, UserProfilePeer::AVATAR => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'FIRSTNAME' => 1, 'LASTNAME' => 2, 'NICKNAME' => 3, 'AVATAR' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'firstname' => 1, 'lastname' => 2, 'nickname' => 3, 'avatar' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UserProfilePeer::FIRSTNAME);
            $criteria->addSelectColumn(UserProfilePeer::LASTNAME);
            $criteria->addSelectColumn(UserProfilePeer::NICKNAME);
            $criteria->addSelectColumn(UserProfilePeer::AVATAR);
        } else {
    ...
    /**
     * Method to invalidate the instance pool of all tables related to user_profiles
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (UserProfile) to the collection in $obj2 (User)
                $obj1->setUser($obj2);
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseUserProfilePeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \AnthemCM\UserProfile\Model\map\UserProfileTableMap());
      }
    }
    ...
    /**
     * Deletes all rows from the user_profiles table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
