...
/**
 * Base class that represents a row from the 'feedbacks' table.
 *
 *
 *
...
abstract class BaseFeedback extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'AnthemCM\\Feedback\\Model\\FeedbackPeer';
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[] = FeedbackPeer::USER_ID;
        }
    ...
    public function setContent($v)
    {
        ...
        if ($this->content !== $v) {
            $this->content = $v;
            $this->modifiedColumns[] = FeedbackPeer::CONTENT;
        }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = FeedbackPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 6; // 6 = FeedbackPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        if (!$this->isColumnModified(FeedbackPeer::CREATED_AT))
        {
            $this->setCreatedAt(time());
        }
        if (!$this->isColumnModified(FeedbackPeer::UPDATED_AT))
        {
        ...
        // timestampable behavior
        if ($this->isModified() && !$this->isColumnModified(FeedbackPeer::UPDATED_AT))
        {
            $this->setUpdatedAt(time());
        }
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(FeedbackPeer::USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`user_id`';
        }
        if ($this->isColumnModified(FeedbackPeer::EMAIL)) {
            $modifiedColumns[':p' . $index++]  = '`email`';
        }
        if ($this->isColumnModified(FeedbackPeer::CONTENT)) {
        ...
        $sql = sprintf(
            'INSERT INTO `feedbacks` (%s) VALUES (%s)',
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(FeedbackPeer::USER_ID)) $criteria->add(FeedbackPeer::USER_ID, $this->user_id);
        if ($this->isColumnModified(FeedbackPeer::EMAIL)) $criteria->add(FeedbackPeer::EMAIL, $this->email);
        if ($this->isColumnModified(FeedbackPeer::CONTENT)) $criteria->add(FeedbackPeer::CONTENT, $this->content);
        if ($this->isColumnModified(FeedbackPeer::CREATED_AT)) $criteria->add(FeedbackPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(FeedbackPeer::UPDATED_AT)) $criteria->add(FeedbackPeer::UPDATED_AT, $this->updated_at);
