...
use AnthemCM\Pages\Model\map\PageTableMap;
...
abstract class BasePagePeer
{
    ...
    const OM_CLASS = 'AnthemCM\\Pages\\Model\\Page';

    /** the related TableMap class for this table */
    const TM_CLASS = 'AnthemCM\\Pages\\Model\\map\\PageTableMap';
    ...
    const IS_ACTIVE = 'pages.is_active';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Title', 'Url', 'Content', 'IsActive', 'CreatedAt', 'UpdatedAt', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'title', 'url', 'content', 'isActive', 'createdAt', 'updatedAt', ),
        BasePeer::TYPE_COLNAME => array (PagePeer::ID, PagePeer::TITLE, PagePeer::URL, PagePeer::CONTENT, PagePeer::IS_ACTIVE, PagePeer::CREATED_AT, PagePeer::UPDATED_AT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'TITLE', 'URL', 'CONTENT', 'IS_ACTIVE', 'CREATED_AT', 'UPDATED_AT', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'title', 'url', 'content', 'is_active', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Title' => 1, 'Url' => 2, 'Content' => 3, 'IsActive' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'title' => 1, 'url' => 2, 'content' => 3, 'isActive' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
        BasePeer::TYPE_COLNAME => array (PagePeer::ID => 0, PagePeer::TITLE => 1, PagePeer::URL => 2, PagePeer::CONTENT => 3, PagePeer::IS_ACTIVE => 4, PagePeer::CREATED_AT => 5, PagePeer::UPDATED_AT => 6, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'TITLE' => 1, 'URL' => 2, 'CONTENT' => 3, 'IS_ACTIVE' => 4, 'CREATED_AT' => 5, 'UPDATED_AT' => 6, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'title' => 1, 'url' => 2, 'content' => 3, 'is_active' => 4, 'created_at' => 5, 'updated_at' => 6, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PagePeer::IS_ACTIVE);
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BasePagePeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \AnthemCM\Pages\Model\map\PageTableMap());
      }
    }
