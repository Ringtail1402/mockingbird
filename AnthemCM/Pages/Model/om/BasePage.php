...
abstract class BasePage extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'AnthemCM\\Pages\\Model\\PagePeer';
    ...
    public function setIsActive($v)
    {
        ...
        if ($this->is_active !== $v) {
            $this->is_active = $v;
            $this->modifiedColumns[] = PagePeer::IS_ACTIVE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 7; // 7 = PagePeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PagePeer::CONTENT)) {
            $modifiedColumns[':p' . $index++]  = '`content`';
        }
        if ($this->isColumnModified(PagePeer::IS_ACTIVE)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PagePeer::IS_ACTIVE)) $criteria->add(PagePeer::IS_ACTIVE, $this->is_active);
