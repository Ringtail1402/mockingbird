...
namespace Anthem\Settings\Model\om;
...
use Anthem\Settings\Model\map\SettingTableMap;
 ...
 *
 *
 * @package propel.generator.Anthem.Settings.Model.om
 */
abstract class BaseSettingPeer
{
    ...
    const OM_CLASS = 'Anthem\\Settings\\Model\\Setting';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Anthem\\Settings\\Model\\map\\SettingTableMap';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Key', 'Value', 'UserId', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'key', 'value', 'userId', ),
        BasePeer::TYPE_COLNAME => array (SettingPeer::ID, SettingPeer::KEY, SettingPeer::VALUE, SettingPeer::USER_ID, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'KEY', 'VALUE', 'USER_ID', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'key', 'value', 'user_id', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Key' => 1, 'Value' => 2, 'UserId' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'key' => 1, 'value' => 2, 'userId' => 3, ),
        BasePeer::TYPE_COLNAME => array (SettingPeer::ID => 0, SettingPeer::KEY => 1, SettingPeer::VALUE => 2, SettingPeer::USER_ID => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'KEY' => 1, 'VALUE' => 2, 'USER_ID' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'key' => 1, 'value' => 2, 'user_id' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SettingPeer::USER_ID);
        } else {
    ...
    public static function doCountJoinUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(SettingPeer::USER_ID, UserPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Setting objects pre-filled with their User objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        SettingPeer::addSelectColumns($criteria);
        $startcol = SettingPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Setting) to $obj2 (User)
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        SettingPeer::addSelectColumns($criteria);
        $startcol2 = SettingPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Setting) to the collection in $obj2 (User)
                $obj2->addSetting($obj1);
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseSettingPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Anthem\Settings\Model\map\SettingTableMap());
      }
    }
