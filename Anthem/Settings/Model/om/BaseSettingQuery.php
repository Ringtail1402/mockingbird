 ...
 * @method SettingQuery orderByUserId($order = Criteria::ASC) Order by the user_id column
 *
 ...
 * @method SettingQuery groupByUserId() Group by the user_id column
 *
 ...
 *
 * @method SettingQuery leftJoinUser($relationAlias = null) Adds a LEFT JOIN clause to the query using the User relation
 * @method SettingQuery rightJoinUser($relationAlias = null) Adds a RIGHT JOIN clause to the query using the User relation
 * @method SettingQuery innerJoinUser($relationAlias = null) Adds a INNER JOIN clause to the query using the User relation
 *
 ...
 * @method Setting findOneByUserId(int $user_id) Return the first Setting filtered by the user_id column
 *
 ...
 * @method array findByUserId(int $user_id) Return Setting objects filtered by the user_id column
 *
...
abstract class BaseSettingQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'Anthem\\Settings\\Model\\Setting';
        }
    ...
    {
        $sql = 'SELECT `id`, `key`, `value`, `user_id` FROM `settings` WHERE `id` = :p0';
        try {
    ...
    public function filterByUserId($userId = null, $comparison = null)
    {
        if (is_array($userId)) {
            $useMinMax = false;
            if (isset($userId['min'])) {
                $this->addUsingAlias(SettingPeer::USER_ID, $userId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($userId['max'])) {
                $this->addUsingAlias(SettingPeer::USER_ID, $userId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(SettingPeer::USER_ID, $userId, $comparison);
    }
    ...
    public function filterByUser($user, $comparison = null)
    {
        if ($user instanceof User) {
            return $this
                ->addUsingAlias(SettingPeer::USER_ID, $user->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(SettingPeer::USER_ID, $user->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
