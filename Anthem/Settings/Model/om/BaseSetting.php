...
abstract class BaseSetting extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Anthem\\Settings\\Model\\SettingPeer';
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[] = SettingPeer::USER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 4; // 4 = SettingPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = SettingQuery::create()
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(SettingPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(SettingPeer::KEY)) {
            $modifiedColumns[':p' . $index++]  = '`key`';
        }
        if ($this->isColumnModified(SettingPeer::VALUE)) {
            $modifiedColumns[':p' . $index++]  = '`value`';
        }
        if ($this->isColumnModified(SettingPeer::USER_ID)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SettingPeer::USER_ID)) $criteria->add(SettingPeer::USER_ID, $this->user_id);
     ...
     *
     * @return string The value of the 'key' column
     */
