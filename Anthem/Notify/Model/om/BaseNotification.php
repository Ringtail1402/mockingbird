...
abstract class BaseNotification extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Anthem\\Notify\\Model\\NotificationPeer';
    ...
    /**
     * The value for the output_class field.
     * @var        string
     */
    protected $output_class;

    /**
     * The value for the no_dismiss field.
     * Note: this column has a database default value of: false
     * @var        boolean
     */
    protected $no_dismiss;
    ...
    /**
     * The value for the policies field.
     * @var        string
     */
    protected $policies;
    ...
    /**
     * Get the [output_class] column value.
     *
     * @return string
     */
    ...
    /**
     * Get the [no_dismiss] column value.
     *
     * @return boolean
     */
    public function getNoDismiss()
    {

        return $this->no_dismiss;
    }
    ...
    public function setUniqid($v)
    {
        ...
        if ($this->uniqid !== $v) {
            $this->uniqid = $v;
            $this->modifiedColumns[] = NotificationPeer::UNIQID;
        }
    ...
    /**
     * Set the value of [output_class] column.
     *
     * @param  string $v new value
     * @return Notification The current object (for fluent API support)
     */
    public function setOutputClass($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->output_class !== $v) {
            $this->output_class = $v;
            $this->modifiedColumns[] = NotificationPeer::OUTPUT_CLASS;
        }
    ...
    /**
     * Sets the value of the [no_dismiss] column.
     ...
     * @return Notification The current object (for fluent API support)
     */
    public function setNoDismiss($v)
    {
        if ($v !== null) {
            if (is_string($v)) {
        ...
        if ($this->no_dismiss !== $v) {
            $this->no_dismiss = $v;
            $this->modifiedColumns[] = NotificationPeer::NO_DISMISS;
        }
    ...
    /**
     * Set the value of [policies] column.
     *
     * @param  string $v new value
     * @return Notification The current object (for fluent API support)
     */
    public function setPolicies($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->policies !== $v) {
            $this->policies = $v;
            $this->modifiedColumns[] = NotificationPeer::POLICIES;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->output_class = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->no_dismiss = ($row[$startcol + 4] !== null) ? (boolean) $row[$startcol + 4] : null;
            $this->user_id = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
            $this->policies = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
            ...
            return $startcol + 9; // 9 = NotificationPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        if (!$this->isColumnModified(NotificationPeer::CREATED_AT))
        {
            $this->setCreatedAt(time());
        }
        if (!$this->isColumnModified(NotificationPeer::UPDATED_AT))
        {
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(NotificationPeer::UNIQID)) {
            $modifiedColumns[':p' . $index++]  = '`uniqid`';
        }
        if ($this->isColumnModified(NotificationPeer::MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = '`message`';
        }
        if ($this->isColumnModified(NotificationPeer::OUTPUT_CLASS)) {
            $modifiedColumns[':p' . $index++]  = '`output_class`';
        }
        if ($this->isColumnModified(NotificationPeer::NO_DISMISS)) {
            $modifiedColumns[':p' . $index++]  = '`no_dismiss`';
        }
        if ($this->isColumnModified(NotificationPeer::USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`user_id`';
        }
        if ($this->isColumnModified(NotificationPeer::POLICIES)) {
            $modifiedColumns[':p' . $index++]  = '`policies`';
        }
        if ($this->isColumnModified(NotificationPeer::CREATED_AT)) {
        ...
        try {
            ...
            $stmt->bindValue($identifier, $this->message, PDO::PARAM_STR);
                        break;
                    case '`output_class`':
            $stmt->bindValue($identifier, $this->output_class, PDO::PARAM_STR);
                        break;
                    case '`no_dismiss`':
            $stmt->bindValue($identifier, (int) $this->no_dismiss, PDO::PARAM_INT);
                        break;
                    case '`user_id`':
            $stmt->bindValue($identifier, $this->user_id, PDO::PARAM_INT);
                        break;
                    case '`policies`':
            $stmt->bindValue($identifier, $this->policies, PDO::PARAM_STR);
                        break;
                    case '`created_at`':
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 2:
                ...
                break;
            case 3:
                return $this->getOutputClass();
                break;
            case 4:
                return $this->getNoDismiss();
                break;
            case 5:
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[3] => $this->getOutputClass(),
            $keys[4] => $this->getNoDismiss(),
            $keys[5] => $this->getUserId(),
            $keys[6] => $this->getPolicies(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 2:
                ...
                break;
            case 3:
                $this->setOutputClass($value);
                break;
            case 4:
                $this->setNoDismiss($value);
                break;
            case 5:
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setOutputClass($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setNoDismiss($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setUserId($arr[$keys[5]]);
        if (array_key_exists($keys[6], $arr)) $this->setPolicies($arr[$keys[6]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(NotificationPeer::UNIQID)) $criteria->add(NotificationPeer::UNIQID, $this->uniqid);
        if ($this->isColumnModified(NotificationPeer::MESSAGE)) $criteria->add(NotificationPeer::MESSAGE, $this->message);
        if ($this->isColumnModified(NotificationPeer::OUTPUT_CLASS)) $criteria->add(NotificationPeer::OUTPUT_CLASS, $this->output_class);
        if ($this->isColumnModified(NotificationPeer::NO_DISMISS)) $criteria->add(NotificationPeer::NO_DISMISS, $this->no_dismiss);
        if ($this->isColumnModified(NotificationPeer::USER_ID)) $criteria->add(NotificationPeer::USER_ID, $this->user_id);
        if ($this->isColumnModified(NotificationPeer::POLICIES)) $criteria->add(NotificationPeer::POLICIES, $this->policies);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setOutputClass($this->getOutputClass());
        $copyObj->setNoDismiss($this->getNoDismiss());
        $copyObj->setUserId($this->getUserId());
        $copyObj->setPolicies($this->getPolicies());
