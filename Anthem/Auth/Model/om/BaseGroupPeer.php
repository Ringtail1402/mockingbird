...
use Anthem\Auth\Model\map\GroupTableMap;
...
abstract class BaseGroupPeer
{
    ...
    const OM_CLASS = 'Anthem\\Auth\\Model\\Group';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Anthem\\Auth\\Model\\map\\GroupTableMap';
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (GroupPeer::ID, GroupPeer::TITLE, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (GroupPeer::ID => 0, GroupPeer::TITLE => 1, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(GroupPeer::TITLE);
        } else {
    ...
    {
        // Invalidate objects in GroupPolicyPeer instance pool,
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseGroupPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Anthem\Auth\Model\map\GroupTableMap());
      }
    }
