...
abstract class BaseGroup extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Anthem\\Auth\\Model\\GroupPeer';
    ...
    /**
     * @var        PropelObjectCollection|GroupPolicy[] Collection to store aggregation of GroupPolicy objects.
     */
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(GroupPeer::TITLE)) {
    ...
    public function initPolicys($overrideExisting = true)
    {
        ...
        $this->collPolicys->setModel('GroupPolicy');
    }

    /**
     * Gets an array of GroupPolicy objects which contain a foreign key that references this object.
     *
     ...
     * @return PropelObjectCollection|GroupPolicy[] List of GroupPolicy objects
     * @throws PropelException
     */
    public function getPolicys($criteria = null, PropelPDO $con = null)
    {
        ...
        if (null === $this->collPolicys || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collPolicys) {
                ...
                $collPolicys = GroupPolicyQuery::create(null, $criteria)
                    ->filterByGroup($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    public function countPolicys(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        ...
        if (null === $this->collPolicys || null !== $criteria || $partial) {
            ...
            $query = GroupPolicyQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
    ...
    /**
     * Method called to associate a GroupPolicy object to this object
     * through the GroupPolicy foreign key attribute.
     *
     * @param    GroupPolicy $l GroupPolicy
     * @return Group The current object (for fluent API support)
     */
    public function addPolicy(GroupPolicy $l)
    {
        if ($this->collPolicys === null) {
            $this->initPolicys();
            $this->collPolicysPartial = true;
     ...
     * @return PropelObjectCollection|RefUserGroup[] List of RefUserGroup objects
     */
    public function getRefGroupsJoinUser($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = RefUserGroupQuery::create(null, $criteria);
     ...
     *
     * @param  User $user The RefUserGroup object to relate
     * @return Group The current object (for fluent API support)
     */
    ...
    protected function doAddUser(User $user)
    {
        ...
        if (!$user->getGroups()->contains($this)) { $refUserGroup = new RefUserGroup();
            $refUserGroup->setUser($user);
