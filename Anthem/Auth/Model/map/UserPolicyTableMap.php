...
/**
 * This class defines the structure of the 'user_policies' table.
 *
 *
 *
 ...
 */
class UserPolicyTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'Anthem.Auth.Model.map.UserPolicyTableMap';
    ...
    {
        // attributes
        $this->setName('user_policies');
        $this->setPhpName('UserPolicy');
        $this->setClassname('Anthem\\Auth\\Model\\UserPolicy');
