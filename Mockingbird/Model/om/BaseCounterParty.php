...
/**
 * Base class that represents a row from the 'counter_parties' table.
 *
 *
 *
 * @package    propel.generator.Mockingbird.Model.om
 */
abstract class BaseCounterParty extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Mockingbird\\Model\\CounterPartyPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CounterPartyPeer
     */
     ...
     * @return CounterParty The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CounterPartyPeer::ID;
        }
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[] = CounterPartyPeer::USER_ID;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[] = CounterPartyPeer::TITLE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = CounterPartyPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CounterParty object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CounterPartyPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CounterPartyQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CounterPartyPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CounterPartyPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CounterPartyPeer::USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`user_id`';
        }
        if ($this->isColumnModified(CounterPartyPeer::TITLE)) {
            $modifiedColumns[':p' . $index++]  = '`title`';
        }

        $sql = sprintf(
            'INSERT INTO `counter_parties` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CounterPartyPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CounterPartyPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CounterParty'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CounterParty'][$this->getPrimaryKey()] = true;
        $keys = CounterPartyPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CounterPartyPeer::ID)) $criteria->add(CounterPartyPeer::ID, $this->id);
        if ($this->isColumnModified(CounterPartyPeer::USER_ID)) $criteria->add(CounterPartyPeer::USER_ID, $this->user_id);
        if ($this->isColumnModified(CounterPartyPeer::TITLE)) $criteria->add(CounterPartyPeer::TITLE, $this->title);
    ...
    {
        $criteria = new Criteria(CounterPartyPeer::DATABASE_NAME);
        $criteria->add(CounterPartyPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of CounterParty (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CounterParty Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CounterPartyPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CounterPartyPeer();
        }
    ...
    public function getUser(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUser === null && ($this->user_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aUser->addCounterPartys($this);
             */
        }
     ...
     * If this CounterParty is new, it will return
    ...
    public function setTransactionss(PropelCollection $transactionss, PropelPDO $con = null)
    {
        ...
        foreach ($transactionssToDelete as $transactionsRemoved) {
            $transactionsRemoved->setCounterParty(null);
        }
    ...
    protected function doAddTransactions($transactions)
    {
        ...
        $transactions->setCounterParty($this);
    }
    ...
    public function removeTransactions($transactions)
    {
        if ($this->getTransactionss()->contains($transactions)) {
            ...
            $transactions->setCounterParty(null);
        }
     ...
     * Otherwise if this CounterParty is new, it will return
     * an empty collection; or if this CounterParty has previously
     * been saved, it will retrieve related Transactionss from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in CounterParty.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
