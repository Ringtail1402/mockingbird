...
use Mockingbird\Model\map\CurrencyTableMap;

/**
 * Base static class for performing query and update operations on the 'currencies' table.
 *
 *
 *
...
abstract class BaseCurrencyPeer
{
    ...
    const OM_CLASS = 'Mockingbird\\Model\\Currency';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Mockingbird\\Model\\map\\CurrencyTableMap';
    ...
    const ID = 'currencies.id';

    /** the column name for the title field */
    const TITLE = 'currencies.title';

    /** the column name for the format field */
    const FORMAT = 'currencies.format';

    /** the column name for the is_primary field */
    const IS_PRIMARY = 'currencies.is_primary';

    /** the column name for the rate_to_primary field */
    const RATE_TO_PRIMARY = 'currencies.rate_to_primary';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Title', 'Format', 'IsPrimary', 'RateToPrimary', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'title', 'format', 'isPrimary', 'rateToPrimary', ),
        BasePeer::TYPE_COLNAME => array (CurrencyPeer::ID, CurrencyPeer::TITLE, CurrencyPeer::FORMAT, CurrencyPeer::IS_PRIMARY, CurrencyPeer::RATE_TO_PRIMARY, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'TITLE', 'FORMAT', 'IS_PRIMARY', 'RATE_TO_PRIMARY', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'title', 'format', 'is_primary', 'rate_to_primary', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Title' => 1, 'Format' => 2, 'IsPrimary' => 3, 'RateToPrimary' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'title' => 1, 'format' => 2, 'isPrimary' => 3, 'rateToPrimary' => 4, ),
        BasePeer::TYPE_COLNAME => array (CurrencyPeer::ID => 0, CurrencyPeer::TITLE => 1, CurrencyPeer::FORMAT => 2, CurrencyPeer::IS_PRIMARY => 3, CurrencyPeer::RATE_TO_PRIMARY => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'TITLE' => 1, 'FORMAT' => 2, 'IS_PRIMARY' => 3, 'RATE_TO_PRIMARY' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'title' => 1, 'format' => 2, 'is_primary' => 3, 'rate_to_primary' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CurrencyPeer::FORMAT);
            $criteria->addSelectColumn(CurrencyPeer::IS_PRIMARY);
            $criteria->addSelectColumn(CurrencyPeer::RATE_TO_PRIMARY);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.title');
            $criteria->addSelectColumn($alias . '.format');
            $criteria->addSelectColumn($alias . '.is_primary');
            $criteria->addSelectColumn($alias . '.rate_to_primary');
        }
    }
    ...
    /**
     * Method to invalidate the instance pool of all tables related to currencies
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCurrencyPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Mockingbird\Model\map\CurrencyTableMap());
      }
    }
